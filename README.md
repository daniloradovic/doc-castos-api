# castos-doc OpenAPI Specification
[![Build Status](https://travis-ci.org/daniloradovic/doc-castos-api.svg?branch=master)](https://travis-ci.org/daniloradovic/doc-castos-api)
...
6. If you did everything correct, https://daniloradovic.github.io/doc-castos-api/ will lead to your new docs
...
- Documentation(ReDoc): https://daniloradovic.github.io/doc-castos-api/
- SwaggerUI: https://daniloradovic.github.io/doc-castos-api/swagger-ui/
- Look full spec:
    + JSON https://daniloradovic.github.io/doc-castos-api/swagger.json
    + YAML https://daniloradovic.github.io/doc-castos-api/swagger.yaml
- Preview spec version for branch `[branch]`: https://daniloradovic.github.io/doc-castos-api/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://daniloradovic.github.io/doc-castos-api/ with url from the message: `Server started <url>`
